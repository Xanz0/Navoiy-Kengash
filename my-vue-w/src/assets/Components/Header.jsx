...
//   // const toggleMenu = () => {
//   // seconst Navigation = ({ navItems, dropdownItems, t }) => {
// //   const [activeDropdown, setActiveDropdown] = useState(null);
// //   const [isMenuOpen, setIsMenuOpen] = useState(false);tIsMenuOpen(!isMenuOpen);
// };
//              {isMenuOpen && (
//   <div className="mobile-menu">
//     <ul className="mobile-nav-ul" style={{fontFamily: 'Inter, sans-serif'}}>
//       {navItems.map((item) => (
//         <li
//           key={item}
...
//                       alt={t("uzbCoatOfArms")}
//                     />
//                      <h3 style={{fontWeight:1000, fontSize:"16px",lineHeight: "120%", color:"#313131"}}>{t("regionalCouncil")}</h3>
//                   </div>
//                     </Link>
...
//                 <ul className="nav-ul" style={{fontFamily: 'Inter, sans-serif'}}>
//                   {navItems.map((item) => (
//                     <li
//                       key={item}
//                       className={`nav-item ${
