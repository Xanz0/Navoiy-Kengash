...
//   // Dropdown config: label and path
//   const dropdownItems = {
//     "Biz haqimizda": [
//       { label: "Raxbarlar", path: "/raxbarlar" },
//       { label: "Tuzilma", path: "/tuzilma" },
...
//       { label: "Qonunlar", path: "/qonunlar" },
//       { label: "Farmonlar", path: "/farmonlar" },
//       { label: "Qonun-hujjatlari-ijrosini-o'rganish", path: "/qonun-hujjatlari-ijrosini-o-rganish" },
//     ],
//     "Majlislar": [
//       { label: "Yalpi majlislar", path: "/yalpi-majlislar" },
//       { label: "Parlament-eshituvlari", path: "/parlament-eshituvlari" },
...
//               </div>
//               <div className="top-mid">
//                 <span className="dd"> {/* clock icon SVG */} </span>
//                 <p>{t("siteInTestMode")}</p>
//               </div>
//               <div className="top-right">
//                 <p className="right-desc">{t("weAreInSocial")}</p>
...
//                     <a key={idx} href={social.url} className={social.className} target="_blank" rel="noopener noreferrer">
//                       <li className="icons-item">{social.icon}</li>
//                     </a>
//                   ))}
//                 </ul>
...
//                 {/* Left logo/title */}
//                 <div className="middle-left">
//                   <img src="https://web.archive.org/web/20121102102633/http://upload.wikimedia.org/wikipedia/commons/5/5d/Coat_of_Arms_of_Uzbekistan.svg" alt={t("uzbCoatOfArms")} />
//                   <h3>{t("regionalCouncil")}</h3>
//                 </div>
//                 {/* Right accessibility, signup, lang, login */}
//                 <div className="middle-right">
//                   {/* Accessibility */}
//                   <div className="right-r1" style={{ position: "relative" }}>
//                     <GiSunglasses onClick={() => setShowAccessibility(!showAccessibility)} aria-label={t("accessibilitySettings")} />
//                     {showAccessibility && (
//                       <div className="accessibility-menu">
...
//                   </div>
//                   {/* Language */}
//                   <div className="right-r3" style={{ position: "relative" }} onClick={() => setShowLanguageMenu(v => !v)}>
//                     <RiTranslate2 />
//                     <p>{languages.find(l => l.code === i18n.language)?.label}</p>
//                     {showLanguageMenu && (
//                       <div className="language-menu2233">
//                         {languages.map(lang => (
//                           <button key={lang.code} onClick={() => handleLanguageChange(lang.code)} className={i18n.language === lang.code ? "active" : ""}>
//                             {lang.label}
//                           </button>
//                         ))}
//                       </div>
...
//               <ul className="nav-ul">
//                 {navItems.map(item => (
//                   <li key={item} className={`nav-item ${activeDropdown === item ? 'active' : ''}`} onClick={() => toggleDropdown(item)}>
//                     <div className="nav-item-content">
//                       <p>{t(item)}</p>
