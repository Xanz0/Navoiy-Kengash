...
const NewsCards = () => {
    return (
        ...
        <div className="news-card">
            ...
            <img src="https://senat.uz/media/post/slider/0oTnsGChQp6lXCKdvju8PyiBfibVeT.jpg" alt="News 2" width={360}/>
            <h2>News Title 2</h2>
            <p>Farg‘ona viloyati hududlarini ijtimoiy-iqtisodiy rivojlantirishga qaratilgan dasturlar ijrosi muhokama qilindi.</p>
        </div>
        <div className="news-card">
        
            <img src="https://senat.uz/media/post/slider/4e0pBWuwAPRDDLj5rscelT4ty0E1QW.jpg" alt="News 3" width={360}/>
            <h2>News Title 3</h2>
