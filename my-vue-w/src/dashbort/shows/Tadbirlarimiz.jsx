...
const API_URL = `${API_BASE_URL}/api/News/tadbirlar/`;
...
const NewsCRUD = () => {
  ...
  return (
    <div className="container-newsAllCRUd">
      <h2 className='title-news-h1'>Tadbirlar qo'shish</h2>
      <div className="form-news-01">
        ...
        <div className='image-selector'>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
            {images.map((img) => {zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
